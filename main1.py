...
def draw_clock():
    ...
    # Jam
    glColor3f(0, 0.5, 1)
    draw_hand(0.5, math.radians(360 * (hour / 12)) - math.pi / 2, 5)

    # Menit
    glColor3f(0, 1, 0)
    draw_hand(0.7, math.radians(360 * (minute / 60)) - math.pi / 2, 3)

    # Detik
    glColor3f(1, 0, 0)
    draw_hand(0.85, math.radians(360 * (sec / 60)) - math.pi / 2, 1)
...
def main():
    ...
    glutCreateWindow(b"Jam Analog Realistis dengan OpenGL")
    glutDisplayFunc(draw_clock)
    glutIdleFunc(draw_clock)
    glutTimerFunc(1000, update, 0)
